return {
  ...
  keys = function()
    ...
    return {
      ...
      { "<leader>sw", Util.telescope("grep_string", { search = "<C-R><C-W><C-R>"}), desc = "Search word under cursor (root dir)" },
      { "<leader>sW", Util.telescope("grep_string", { search = "<C-R><C-W><C-R>", cwd = false }), desc = "Search Word under cursor (cwd)" },
